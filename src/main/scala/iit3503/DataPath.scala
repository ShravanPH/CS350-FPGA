...
class DataPath extends Module {
 ...
 // TODO: FILL ME IN!
  ...
  val ADDR1MUX = Mux(ctrl.ADDR1MUX, regs.io.sr1Out, PC)


  // TODO: FILL ME IN!


val  ADDR2MUX = MuxLookup(ctrl.ADDR2MUX,SignExt.apply(0.U,16), Seq(
  0.U -> SignExt(0.U,16),
  1.U -> SignExt(IR(5,0),16),
  2.U -> SignExt(IR(8,0),16),
  3.U -> SignExt(IR(10,0),16)
  ...
  // TODO: FILL ME IN!
 MARMUX := Mux(ctrl.MARMUX, addrCalc, ZeroExt(IR(7,0),16))
  ...
  val SR2MUX = Mux(IR(5), SignExt(IR(4,0),16), regs.io.sr2Out) 
